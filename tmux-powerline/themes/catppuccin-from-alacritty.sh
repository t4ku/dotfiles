# ~/dotfiles/tmux-powerline/themes/catppuccin-from-alacritty.sh
BACKGROUND="#181A1F"
FOREGROUND="#ABB2BF"
RED="#E86671"
GREEN="#98C379"
...
# only for window status
TMUX_POWERLINE_WINDOW_STATUS_SEPARATOR_LEFT_BOLD=""
TMUX_POWERLINE_WINDOW_STATUS_SEPARATOR_LEFT_THIN=""
TMUX_POWERLINE_WINDOW_STATUS_SEPARATOR_RIGHT_BOLD=""
TMUX_POWERLINE_WINDOW_STATUS_SEPARATOR_RIGHT_THIN=""
TMUX_POWERLINE_WINDOW_STATUS_SEPARATOR_THIN="|"
...
# UPDATE: use colors defined above
...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
  ...
  # UPDATE: use colors defined above
  TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
      "tmux_session_info $BLUE $BACKGROUND" 
      "vcs_branch $CYAN $BACKGROUND"
  )
fi
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
  ...
  # UPDATE: use colors defined above
  TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
      "date_day $GREEN $BACKGROUND"
      "date $YELLOW $BACKGROUND"
      "time $MAGENTA $BACKGROUND"
  )
fi
